...
import { fetchQuotations, Quotation } from "@/services/quotation";
...
export default function ProposalsPage() {
  ...
  const handleSearchChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setCurrentPage(1);
    fetchQuotationsData(1, itemsPerPage, query);
  };

  // Fetch quotations on component mount
  useEffect(() => {
    if (isAuthenticated) {
      fetchQuotationsData(currentPage, itemsPerPage, searchQuery);
    }
  }, [isAuthenticated]);

  // Function to fetch quotations
  const fetchQuotationsData = async (page: number = currentPage, limit: number = itemsPerPage, search: string = searchQuery) => {
    setIsLoading(true);
    setError(null);

    try {
      console.log(`Fetching quotations - page: ${page}, limit: ${limit}, search: ${search}`);
      const response = await fetchQuotations(page, limit, search);
  ...
  const handleRefresh = () => {
    fetchQuotationsData(currentPage, itemsPerPage, searchQuery);
    toast.success('Refreshed proposals data');
  };

  // Handle page change
  const handlePageChange = (page: number) => {
    setCurrentPage(page);
    fetchQuotationsData(page, itemsPerPage, searchQuery);
  };
  ...
  const handleDownload = (quotation: Quotation) => {
    toast.success(`Downloading proposal ${quotation.name}`);
  };
          ...
          <div className="bg-white/20 dark:bg-neutral-800/20 backdrop-blur-md rounded-xl shadow-lg 
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
              <div className="flex items-center mb-4 md:mb-0">
                <IconFileInvoice size={24} className="text-blue-500 mr-2" />
                ...
                <div className="flex items-center space-x-2">
                  <Select
                    ...
                    onChange={(value) => {
                      ...
                      fetchQuotationsData(1, value, searchQuery);
                    }}
                    options={[
                      { value: 5, label: '5' },
                      { value: 10, label: '10' },
            ...
            {isLoading && (
              <div className="flex items-center justify-center py-16">
                ...
                <p className="ml-4 text-neutral-600 dark:text-neutral-300">Loading proposals...</p>
              </div>
            )}
            ...
            {!isLoading && error && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium">Failed to load proposals</h3>
            ...
            {!isLoading && !error && quotations.length === 0 && (
              <div className="bg-white dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700 p-8 text-center">
                <IconFileInvoice size={48} className="text-neutral-400 dark:text-neutral-500 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-neutral-700 dark:text-neutral-300 mb-2">No proposals found</h3>
                ...
                {quotations.map((quotation) => (
                  <div 
                    ...
                    className="bg-white dark:bg-neutral-800 rounded-xl shadow-md border border-neutral-200 dark:border-neutral-700 
                      overflow-hidden transition-all duration-300 p-4 md:p-6"
                  >
                    <div className="flex flex-col md:flex-row md:items-center justify-between">
                      <div className="flex-grow">
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mr-3">
                            <IconFileInvoice size={20} className="text-blue-600 dark:text-blue-400" />
                          </div>
                          <div>
                            <h3 className="text-lg font-semibold text-neutral-800 dark:text-white">{quotation.name}</h3>
                      ...
                      <div className="mt-4 md:mt-0 flex flex-col md:flex-row md:items-center">
                        <div className="flex items-center mb-3 md:mb-0 md:mr-6">
                          <Avatar className="bg-indigo-100 text-indigo-600 mr-2">
                            {getFirstNameInitial(quotation.createdByName)}
                          </Avatar>
                        ...
                        <div className="text-xl font-bold text-green-600 dark:text-green-400 mb-3 md:mb-0 md:mr-6">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mt-8 gap-4">
                <div className="flex items-center space-x-4">
                  <div className="text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    of <span className="font-medium">{totalItems}</span> proposals
                  </div>
